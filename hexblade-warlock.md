...
Spells 1/1: Dimension Door

Eldritch Invocation 1/1: Lifedrinker
...
[ ] Scimitar: [Belm](https://bg3.wiki/wiki/Belm)
  - `Lower City` Inside an opulent chest behind a locked bookcase in the basement of **Elerrathin's Home** (requires DC Sleight of Hand 18).
...
Keep [Resonance Stone](https://bg3.wiki/wiki/Resonance_Stone) in inventory for increased psychic damage. Found on a table near the Mind-Archive Interface (southwest of Necrotic Laboratory).`Mind Flayer Colony` 
