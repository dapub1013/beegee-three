...
[ ] Gloves: [Gloves of Dexterity](https://bg3.wiki/wiki/Gloves_of_dexterity)
  - `Crèche Y'llek` Sold by **A'jak'nir Jeera**. `X: 1380 Y: -798` Redistribute ability points once Gloves of Dexterity are equipped:
...
[ ] Gloves: [Gloves of Soul Catching](https://bg3.wiki/wiki/Gloves_of_Soul_Catching)
  - `House of Hope` Given by **Hope** for completing her quest *⁠Save Hope*. `X: -6477 Y: 2884` Redistribute ability points once Gloves of Soul Catching are equipped *and* Elixirs of Cloud Giant Strength are avaiable:
