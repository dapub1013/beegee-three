...
Spells 1/1: Ensnaring Strike *or* Longstrider
...
Levels 1-5 same as above *except* **DO NOT TAKE HORDE BREAKER AT LEVEL 3**. Volley renders it useless. Instead, take **Colussus Slayer**.
...
Natural Explorer 1/1: Urban Tracker *or* Wasteland Wanderer: Fire
...
Spells 1/1: Lesser Restoration

Defensive Tactics 1/1: Multiattack Defence
...
**Mirror of Loss:** The Mirror of Loss is a large mirror found in both the **Gauntlet of Shar** at `X: -645 Y: -735` and the **House of Grief** at `X: -474 Y: -1650`. You should already have Dexterity: 20.
...
Favoured Enemy 1/1: Sanctified Stalker

Natural Explorer 1/1: Wasteland Wanderer: Poison *or* Wasteland Wanderer: Fire if Urban Tracker taken at Level 6
...
## Act 1
- Eat goodberries
- Cast **Hunter's Mark** on primary target; use **Spike Growth** on groups of enemies instead of Hunter's Mark.
...
- Continue following **Act 1** strategy.
